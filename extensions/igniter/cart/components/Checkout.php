...
use System\Classes\BaseComponent;use Admin\Models\Orders_model;
...
class Checkout extends BaseComponent
{
    ...
    protected function prepareVars()
    {
        ...
        $this->page['confirmCheckoutEventHandler'] = $this->getEventHandler('onUpdateOrderDetails');
    ...
    public function onUpdateOrderDetails()
    {
        ...
        $data = post();
        $this->orderManager->updateOrderDetails($orderId, $data);
